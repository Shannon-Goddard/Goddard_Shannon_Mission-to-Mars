...
**In this module, we automated a web browser to visit different websites to extract data about the Mission to Mars. We stored it in a NoSQL database [scraping.py](scraping.py), and then render the data in a web application created with Flask [app.py](app.py)
